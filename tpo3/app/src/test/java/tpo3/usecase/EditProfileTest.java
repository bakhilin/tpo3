...
public class EditProfileTest {
    ...
    void editSessions() {
        ...
        drivers.parallelStream().forEach(driver -> {
            ...
            forumPage.doLogin(Utils.LOGIN);
            Utils.getElement(driver, By.xpath("/html/body/div[3]/div[2]/header/div[2]/div[3]/ul/li[3]/div/button")).click();
            Utils.getElement(driver, By.xpath("/html/body/div[3]/div[2]/header/div[2]/div[3]/ul/li[3]/div/ul/li[1]/a")).click();
            Utils.getElement(driver, By.xpath("//*[@id=\"content\"]/div/div/div[2]/div/nav/ul/li/div/ul/li[7]/a")).click();

            WebElement terminate = Utils.getElement(driver, By.xpath("//*[@id=\"content\"]/div/div/div[2]/div/div/div/ul/li[1]/fieldset/ul/li[2]/button"));
            terminate.click();   
        });
